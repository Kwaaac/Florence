...
<head>
  ...
  <title>[Florence] Restaurant/Panini_Toscani</title>
</head>
...
<body>
  ...
  <div class="slider-container" id="gestionTailleSlider">
    <div class="swiper-container main-slider loading">
      <div class="swiper-wrapper">
        <?php
          $dir = '../../../Images/restaurant/Panini_Toscani';
  ...
  <div class="textBox" id="page">
    ...
    <div class="texte">
      <p>Situé à 300 mètres de la cathédrale Santa Maria del Fiorre, cette sandwicherie sert des panini
        authentique composé de produit locaux. De plus, le service n’hésite pas à vous faire goûter leur produit pour vous aider
         à composer votre panini.

        <br>=> Piazza del Duomo, 34, 50122 Firenze FI, Italie
        <br>=> +39 335 572 5544
      </p>
    </div>
