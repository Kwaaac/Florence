...
<head>
  ...
  <title>[Florence] Restaurant/Trattoria_Pallotino</title>
</head>
...
<body>
  ...
  <div class="slider-container" id="gestionTailleSlider">
    <div class="swiper-container main-slider loading">
      <div class="swiper-wrapper">
        <?php
          $dir = '../../../Images/restaurant/Trattoria_Pallotino';
  ...
  <div class="textBox" id="page">
    <div class="indication">
      <p>Trattoria Pallotino</p>
    </div>

    <div class="texte">
      <p>Voulez vous découvrir la cuisine Florentine ? Ce restaurant datant de 1911 pourras sans aucun doute satisfaire votre soif de culture culinaire.
        <br>=> Via Isola delle Stinche, 1r, 50122 Firenze FI, Italie
        <br>=> +39 055 260 8887
