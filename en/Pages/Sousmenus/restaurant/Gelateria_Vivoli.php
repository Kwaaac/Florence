...
<head>
  ...
  <title>[Florence] Restaurant/Gelateria_Vivoli</title>
</head>
...
<body>
  ...
  <div class="slider-container" id="gestionTailleSlider">
    <div class="swiper-container main-slider loading">
      <div class="swiper-wrapper">
        <?php
          $dir = '../../../Images/restaurant/Gelateria_Vivoli';
  ...
  <div class="textBox" id="page">
    <div class="indication">
      <p>Gelateria Vivoli</p>
    </div>

    <div class="texte">
      <p>êtes-vous en train de mourir de chaud ? Ce magasin de crème glacée pourrait vous refroidir grâce à leur parfum de saison. En service depuis 1930, il s’agit du magasin de glace la plus vieille au monde.
        <br>=>  Via dell’Isola delle Stinche, 7r, 50122 Firenze FI, Italie
        <br>=> <a href="http://vivoli.it/en/home-2/">Site web</a>
        <br>=> +39 055 292334
      </p>
    </div>
